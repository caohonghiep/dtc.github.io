...
var ActiveAccountComponent = /** @class */ (function () {
    function ActiveAccountComponent(route, router, authService, pageLoaderService) {
        this.route = route;
        this.router = router;
                    ...
                    case 1:
                        ...
                        if (result.result) {
                            ...
                            dialogRef.afterClosed().subscribe(function () {
                                _this.router.navigate([_this.returnUrl], { queryParams: { username: _this.username, email: _this.email } });
                            });
                        }
                        else {
                            this.errorMessage = "Error: " + result.error;
