...
var ActiveAccountComponent = /** @class */ (function () {
    function ActiveAccountComponent(route, router, authService, pageLoaderService, dialog) {
        this.route = route;
        this.router = router;
    ...
    ActiveAccountComponent.prototype.resendActiveCode = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var routerLink;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        routerLink = 'auth/resend-active-code';
                        return [4 /*yield*/, this.router.navigate([routerLink], { queryParams: { username: this.username, email: this.email } })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ActiveAccountComponent.prototype.activeAccount = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.authService.activeAccount(this.username, this.verificationCode)];
                    case 1:
                        result = _a.sent();
                        this.pageLoaderService.hidePageLoader();
                        if (result.result) {
                            dialogRef = this.dialog.open(_ic_core__WEBPACK_IMPORTED_MODULE_4__["AlertDialog"], {
                                width: '300px',
                                data: "Your Account Has Been Activated!"
                            });
                            dialogRef.afterClosed().subscribe(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.router.navigate([this.loginUrl])];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
    ...
    ActiveAccountComponent.ctorParameters = function () { return [
...
var ChangePasswordComponent = /** @class */ (function () {
    function ChangePasswordComponent(route, router, authService, pageLoaderService) {
        this.route = route;
        this.router = router;
        this.authService = authService;
        this.pageLoaderService = pageLoaderService;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.pageLoaderService.showPageLoader();
                        return [4 /*yield*/, this.authService.changePassword(this.oldPassword, this.newPassword)];
                    case 1:
                        result = _a.sent();
                        this.pageLoaderService.hidePageLoader();
                        if (result.result) {
...
var ResendActiveCodeComponent = /** @class */ (function () {
    function ResendActiveCodeComponent(route, router, authService, pageLoaderService) {
        this.route = route;
        this.router = router;
        this.authService = authService;
        this.pageLoaderService = pageLoaderService;
    ...
    ResendActiveCodeComponent.prototype.ngOnInit = function () {
        this.email = this.route.snapshot.queryParams.email;
        this.username = this.route.snapshot.queryParams.username;
    };
    ResendActiveCodeComponent.prototype.resendActiveAccountCode = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var result;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.pageLoaderService.showPageLoader();
                        return [4 /*yield*/, this.authService.resendActiveAccountCode(this.username)];
                    case 1:
                        result = _a.sent();
                        this.pageLoaderService.hidePageLoader();
                        if (!result.result) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.backToActiveAccount()];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    ResendActiveCodeComponent.prototype.backToActiveAccount = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.router.navigate([this.returnUrl], { queryParams: { username: this.username, email: this.email } })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ResendActiveCodeComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] },
        { type: _ic_core__WEBPACK_IMPORTED_MODULE_4__["PageLoaderService"] }
    ...
    return ResendActiveCodeComponent;
}());
...
var SignInComponent = /** @class */ (function () {
    ...
    */
    function SignInComponent(route, router, authService, pageLoaderService) {
        this.route = route;
        this.router = router;
        this.authService = authService;
        this.pageLoaderService = pageLoaderService;
    ...
    SignInComponent.prototype.ngOnInit = function () {
        ...
        this.authService.addSignInListener(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.router.navigate([this.returnUrl])];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
var SignUpComponent = /** @class */ (function () {
    function SignUpComponent(route, router, authService, pageLoaderService, dialog) {
        this.route = route;
        this.router = router;
        this.authService = authService;
        this.pageLoaderService = pageLoaderService;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.pageLoaderService.showPageLoader();
                        return [4 /*yield*/, this.authService.signUp(this.username, this.email, this.password)];
                    case 1:
                        result = _a.sent();
                        this.pageLoaderService.hidePageLoader();
                        if (result.result) {
