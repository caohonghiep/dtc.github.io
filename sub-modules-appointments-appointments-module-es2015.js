...
/* harmony import */ var _fullcalendar_angular__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @fullcalendar/angular */ "./node_modules/@fullcalendar/angular/fesm2015/fullcalendar-angular.js");
...
const calendarPlugins = [_fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_2__["default"], _fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_4__["default"], _fullcalendar_list__WEBPACK_IMPORTED_MODULE_3__["default"], _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_5__["default"]]; // important!
const buttonTextCompoundInput = {
    today: 'Today',
    month: 'Month',
    week: 'Week',
    day: 'Day',
...
const breadcrumb = [{ title: 'Appointments' }];
let AppointmentsContainer = 
// tslint:disable-next-line:component-class-suffix
class AppointmentsContainer extends _ic_core__WEBPACK_IMPORTED_MODULE_6__["AbstractPageComponent"] {
    constructor(dialog) {
        ...
        this.calendarSetting = {
            ...
            customButtons: {
                ...
                month: {
                    text: 'Month',
                    click: () => {
                        this.calendarSetting.selectable = false;
                    }
                },
                week: {
                    text: 'Week',
                ...
                day: {
                    text: 'Day',
                    click: () => {
                        this.calendarSetting.selectable = true;
                    }
                },
                list: {
                    text: 'List',
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.refreshAppointments();
        });
    }
    refreshAppointments() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.appointments = yield this.appointmentService.searchAppointments({});
    ...
    buildCalendarEvents() {
        this.calendarEvents = this.appointments.map(appointment => {
            return this.buildCalendarEvent(appointment);
        });
        /*
    ...
    openAppointmentDialog(appointment) {
        return new Promise(resolve => {
            this.dialog.open(_components_appointment_dialog_appointment_dialog__WEBPACK_IMPORTED_MODULE_9__["AppointmentDialog"], {
                // width: '300px',
                data: { appointment }
            }).afterClosed().subscribe(editedAppointment => {
    ...
    handleEventClick(info) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const index = this.appointments.findIndex(item => item.id === info.event.id);
            const appointment = this.appointments[index];
            const updatedAppointment = yield this.openAppointmentDialog(appointment);
            if (!!updatedAppointment) {
                const appointments = this.appointments.slice(); // a clone
    ...
    handleSelect(info) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const appointment = this.appointmentService.generateEmptyAppointment();
            appointment.startTime = info.start;
            appointment.endTime = info.end;
            const newAppointment = yield this.openAppointmentDialog(appointment);
            if (!!newAppointment) {
    ...
    eventRender(info) {
        ...
        if (!!startTime) {
            ...
            const timeElement = element.getElementsByClassName('fc-time')[0];
            timeElement.innerText = time;
            timeElement.style.display = 'block';
        }
    }
};
AppointmentsContainer.ctorParameters = () => [
...
const entryComponents = [_components_appointment_dialog_appointment_dialog__WEBPACK_IMPORTED_MODULE_7__["AppointmentDialog"], _components_appointment_information_appointment_information_component__WEBPACK_IMPORTED_MODULE_6__["AppointmentInformationComponent"]];
let AppointmentsModule = class AppointmentsModule {
};
AppointmentsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_appointments_container__WEBPACK_IMPORTED_MODULE_5__["AppointmentsContainer"], ...entryComponents, _pages_appointments_appointments_component__WEBPACK_IMPORTED_MODULE_10__["AppointmentsComponent"]],
        imports: [
...
class AppointmentDialog {
    ...
    completeChange(appointment) {
        this.dialogRef.close(appointment);
    }
};
AppointmentDialog.ctorParameters = () => [
...
let AppointmentInformationComponent = class AppointmentInformationComponent {
    constructor() {
    ...
    compilePeriod() {
        ...
        if (!!this.appointmentDate && !!this.startAppointmentClock && !!this.endAppointmentClock) {
            const date = moment__WEBPACK_IMPORTED_MODULE_3___default()(this.appointmentDate).toDate();
            const startDate = moment__WEBPACK_IMPORTED_MODULE_3___default()(this.appointmentDate);
            const endDate = moment__WEBPACK_IMPORTED_MODULE_3___default()(this.appointmentDate);
            //
    ...
    hasChanged() {
        return !!this.updateProperties && Object.values(this.updateProperties).filter(val => val !== undefined).length > 0;
    }
    ...
    toggleEdit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.editMode) {
                ...
                this.updateProperties = yield this.appointmentService.createOrUpdateAppointment(this.updateProperties);
...
let AppointmentRepository = class AppointmentRepository extends _ic_core_repository_abstract_deep_repository__WEBPACK_IMPORTED_MODULE_3__["AbstractDeepRepository"] {
    constructor() {
        super(_ic_core__WEBPACK_IMPORTED_MODULE_2__["Appointment"]);
    }
};
...
const dummyPath = 'customers/customerId';
let AppointmentService = class AppointmentService {
    constructor() {
    }
    searchAppointments(query) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const appointments = yield this.appointmentRepository.search({}, `customers/customerId`).toPromise();
            for (const appointment of appointments) {
                if (appointment.customer && appointment.customer.id) {
                    appointment.customer = (yield this.customerRepository.get(appointment.customer.id).toPromise()) || new _ic_core__WEBPACK_IMPORTED_MODULE_2__["Customer"]({});
                }
            }
            return appointments;
        });
    }
    generateEmptyAppointment() {
    ...
    createOrUpdateAppointment(updateData) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let result;
            if (updateData.id) {
                yield this.appointmentRepository.update(updateData, dummyPath);
                result = updateData;
            }
            else {
                result = yield this.appointmentRepository.create(updateData, dummyPath);
            }
            return result;
        });
    }
...
//# sourceMappingURL=sub-modules-appointments-appointments-module-es2015.js.map