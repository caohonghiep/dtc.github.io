...
let CustomersComponent = class CustomersComponent extends _ic_core__WEBPACK_IMPORTED_MODULE_2__["AbstractPageComponent"] {
    constructor(customerApi, dialogService, utilityService, router) {
        super(title, breadcrumb);
    ...
    search() {
        ...
        this.customerApi.searchCustomers(searchObject).subscribe(ressult => {
            ...
            this.dataSource.sortingDataAccessor = (obj, property) => {
                let value = _ic_core__WEBPACK_IMPORTED_MODULE_2__["UtilityService"].getDeeplyProperty(obj, property);
    ...
    gotoDetail(customer) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const routerLink = 'accounts/customers/' + customer.id;
            yield this.router.navigate([routerLink]);
        });
    }
};
